...
import type { SecurityFinding, SecurityRule } from "../../src/analyzer/security/model/types";
import { SecurityRuleRegistry } from "../../src/analyzer/security/registry/security-rule-registry";
import { authorizationRules } from "../../src/analyzer/security/rules/authorization";
