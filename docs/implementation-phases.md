...
| 3.7 — Performance Intelligence | Extend performance analysis. | In progress / planned | Roadmap file exists. | `plans/phase-3/3.7-performance-intelligence.md` | Not documented here as current behavior. |
| 3.8 — Plugin SDK | Expose extensibility through a plugin SDK. | In progress / planned | Roadmap file exists. | `plans/phase-3/3.8-plugin-sdk.md` | Not documented here as current behavior. |
