...
export interface PerformanceOperation { readonly kind: PerformanceCostKind; readonly location: PerformanceLocation; readonly repeated?: boolean; readonly bounded?: boolean; readonly blocking?: boolean; readonly external?: boolean; }
...
export interface PerformanceRuleContext { readonly source: string; readonly file: string; readonly ast: TSESTree.Program; readonly operations?: readonly PerformanceOperation[]; readonly settings?: Readonly<Record<string, unknown>>; }
