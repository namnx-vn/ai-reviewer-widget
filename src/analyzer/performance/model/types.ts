...
export interface PerformanceFunctionSummary { readonly name: string; readonly directCostKinds: readonly PerformanceCostKind[]; readonly costKinds: readonly PerformanceCostKind[]; readonly calls: readonly string[]; readonly unknownCalls: readonly string[]; }
...
export interface PerformanceRuleContext { readonly source: string; readonly file: string; readonly ast: TSESTree.Program; readonly operations?: readonly PerformanceOperation[]; readonly databaseAdapters?: readonly PerformanceDatabaseAdapter[]; readonly criticalEntrypoints?: readonly string[]; readonly criticalUiComponents?: readonly string[]; readonly telemetryCallPaths?: readonly string[]; readonly settings?: Readonly<Record<string, unknown>>; }
