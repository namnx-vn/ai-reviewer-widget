...
export const REAL_WORLD_PR_CATALOG: readonly RealWorldCatalogEntry[] = [
  ...
  pr("vercel/next.js", 91597, "perf: skip rewrite processing when no rewrites configured", "performance", "manual-review", "minimized", "vercel-next-91597-empty-rewrites-fast-path"),
  ...
  pr("vercel/next.js", 97203, "[turbopack] Lazily compile dynamic imports in development (client side)", "performance", "manual-review", "minimized", "vercel-next-97203-lazy-dynamic-import-control"),
  pr("vercel/next.js", 97672, "Turbopack: mangle exported names for smaller bundle sizes", "performance", "manual-review", "minimized", "vercel-next-97672-mangle-config-schema-control"),
  ...
  pr("vercel/next.js", 96542, "fix(next/image): don't hang cold transforms when the requester aborts", "performance", "positive-candidate", "minimized", "vercel-next-96542-image-request-abort-sharing"),
  pr("vercel/next.js", 96245, "Only advance the Turbopack HMR hash when compiled output actually changed", "performance", "manual-review", "minimized", "vercel-next-96245-hmr-digest-serialization"),
  ...
  pr("vercel/next.js", 96235, "Fix use cache over- and under-invalidation in dev", "performance", "positive-candidate", "minimized", "vercel-next-96235-dev-router-filter-invalidation"),
  pr("vercel/next.js", 96726, "Discard only cache entries that predate a tag revalidation", "performance", "positive-candidate", "minimized", "vercel-next-96726-cache-tag-revalidation-timestamp"),
  pr("vercel/next.js", 96727, "Reuse completed cache entries for the rest of a request", "performance", "positive-candidate", "minimized", "vercel-next-96727-request-cache-completed-entry"),
  ...
  // Next.js / RSC — 30
  pr("vercel/next.js", 94300, "errors: shorten use cache messages and unify them into one factory", "nextjs-rsc", "manual-review", "minimized", "vercel-next-94300-cache-message-factories-control"),
  pr("vercel/next.js", 97184, "Omit undeclared children slots from app routes", "nextjs-rsc", "manual-review", "minimized", "vercel-next-97184-app-loader-cache-hit-dependency"),
  pr("vercel/next.js", 96819, "Fix missing Pages runtime in adapter Pages API outputs", "nextjs-rsc", "positive-candidate", "minimized", "vercel-next-96819-pages-runtime-trace-control"),
  pr("vercel/next.js", 96775, "Development: don't 404 routes whose files exist on disk", "nextjs-rsc", "positive-candidate"),
  pr("vercel/next.js", 96782, "Turbopack: replace the ensurePage wait deadline with a route probe", "nextjs-rsc", "manual-review", "minimized", "vercel-next-96782-route-probe-control"),
  pr("vercel/next.js", 96784, "Serve a new dev route as soon as Turbopack announces it", "nextjs-rsc", "manual-review"),
  pr("vercel/next.js", 96785, "Turbopack: derive the dev route matchers from the entrypoints", "nextjs-rsc", "manual-review", "minimized", "vercel-next-96785-route-refresh-miss-error"),
  pr("vercel/next.js", 96786, "Give route-shaped dev server strings distinct types", "nextjs-rsc", "negative-control", "minimized", "vercel-next-96786-branded-route-types-control"),
  pr("vercel/next.js", 96873, "Scope app entry export validation to the app directory", "nextjs-rsc", "positive-candidate"),
  pr("vercel/next.js", 96406, "Unify RouteTree and CacheNodeSeedData on the client", "nextjs-rsc", "manual-review", "minimized", "vercel-next-96406-route-tree-unification-control"),
  pr("vercel/next.js", 96439, "Unify full/partial navigation response types", "nextjs-rsc", "manual-review", "minimized", "vercel-next-96439-transport-tree-zipper-control"),
  ...
  pr("vercel/next.js", 96776, "Detect sibling root layouts when collecting root params", "nextjs-rsc", "positive-candidate", "minimized", "vercel-next-96776-sibling-root-layout-filter"),
  pr("vercel/next.js", 85320, "use server should error when used in pages dir", "nextjs-rsc", "positive-candidate", "minimized", "vercel-next-85320-pages-use-server-boundary"),
  ...
  pr("vercel/next.js", 96670, "Remove cache revalidation execution mode reads", "nextjs-rsc", "negative-control", "minimized", "vercel-next-96670-stale-revalidation-switch-control"),
  pr("vercel/next.js", 96674, "Remove WorkStore execution mode", "nextjs-rsc", "negative-control", "minimized", "vercel-next-96674-work-unit-switch-control"),
  pr("vercel/next.js", 92861, "[otel]: add spans for various cache components warmup phases", "nextjs-rsc", "manual-review"),
  pr("vercel/next.js", 96347, "feat(turbopack): defer dynamic import chunks in development", "nextjs-rsc", "manual-review", "minimized", "vercel-next-96347-lazy-chunk-feature-gate"),
  ...
  pr("vercel/next.js", 96695, "Serialize prerender manifest updates in dev", "nextjs-rsc", "positive-candidate", "minimized", "vercel-next-96695-prerender-manifest-write-race"),
  ...
  pr("vercel/next.js", 96651, "fix: preserve repeated --require/--import flags when forking workers", "nextjs-rsc", "positive-candidate", "minimized", "vercel-next-96651-node-options-repeated-flags"),
  pr("vercel/next.js", 93291, "[ci]: ensure latest tag is not stale", "nextjs-rsc", "manual-review"),
  pr("vercel/next.js", 97818, "fix(router-utils): remove res close listeners in proxyRequest finally block", "nextjs-rsc", "positive-candidate", "minimized", "vercel-next-97818-proxy-response-listener-cleanup"),
  ...
  pr("vercel/next.js", 96731, "Derive foreground cache revalidation from the consumer", "nextjs-rsc", "manual-review", "minimized", "vercel-next-96731-nested-cache-revalidation-scope"),
