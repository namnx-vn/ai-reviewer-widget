...
| 3.7 | ✅ Complete | Performance Intelligence | [3.7](./3.7-performance-intelligence/README.md) |
...
The repository contains validated production code for:
...
- repository-aware deterministic performance analysis, complete Phase 3.7 rule families, cross-file cost propagation, profiles, and quality gates
- typed Plugin SDK registry and runtime

Every Phase 3 plan from 3.1 through 3.8 now has its implementation boundary represented in the codebase and regression suite.

---

## Validation

Phase completion is backed by the repository quality gates:
...
plus CI coverage and end-to-end validation where applicable.

The repository is the source of truth: status follows implemented and validated behavior, not roadmap intent.
